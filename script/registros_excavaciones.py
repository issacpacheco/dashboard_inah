                    ...
                    if file.endswith('.xlsx') and '01. REGISTRO' in root:
                        ...
                        try:
                            ...
                            for _, row in df.iterrows():
                                ...
                                # Validar clave_excavacion que no termine con "_"
                                if pd.isna(clave_excavacion) or clave_excavacion == "" or str(clave_excavacion).endswith("_"):
                                    continue

                                # Verificar si ya existe el registro y que no termine con "_"
                                sql_check = """
                                    SELECT COUNT(*) FROM registro_excavacion 
                                    WHERE codigo_poligono = %s AND clave_registro = %s AND clave_excavacion = %s AND clave_excavacion NOT LIKE %s
                                """
                                cursor.execute(sql_check, (codigo_poligono, clave_registro, clave_excavacion, '%_'))
                                ...
                                try:
                                    ...
                                    sql_check_topo = """
                                        SELECT id_punto, n, e, z, codigo, zona_utm FROM tren_carga.tc_topografia WHERE id_punto = %s AND codigo = %s
                                    """
                                    ...
                                    if result:
                                        _, n, e, z, codigo, zona_utm = result
                                        ...
                                        # Obtenemos el id_enlace del registro
                                        sql_enlace = """
                                            SELECT id_enlace FROM bitacora 
                                            WHERE id_monumento = %s
                                        """
                                        cursor.execute(sql_enlace, (clave_registro,))
                                        id_enlace = cursor.fetchone()
                                        id_enlace = id_enlace[0] if id_enlace else None
                                        ...
                                        if exists:
                                            ...
                                            sql_update_topografia = """
                                                UPDATE registro_excavacion_topografia SET
                                                    ...
                                                    meteria_prima = %s, asociacion = %s, descripcion_punto = %s, descripcion_estrato = %s,
                                                    fecha_registro = %s, foto_1 = %s, foto_2 = %s, foto_3 = %s, foto_4 = %s,
                                                    n = %s, e = %s, z = %s, codigo_topo = %s, zona_utm = %s, id_enlace = %s
                                                WHERE codigo_poligono = %s AND clave_registro = %s AND clave_excavacion = %s
                                            """
                                            valores_update_topografia = tuple(valores_base + [n, e, z, codigo, zona_utm, id_enlace] + [codigo_poligono, clave_registro, clave_excavacion])
                                            ...
                                            sql_insert_topografia = """
                                                INSERT INTO registro_excavacion_topografia(
                                                    ...
                                                    tipo_excavacion, coordenada_x, coordenada_y, capa, material, meteria_prima, asociacion,
                                                    descripcion_punto, descripcion_estrato, fecha_registro, foto_1, foto_2, foto_3, foto_4,
                                                    n, e, z, codigo_topo, zona_utm, id_enlace)
                                                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
                                                        %s, %s, %s, %s, %s, %s)
                                            """
                                            valores_topografia = tuple(
                                                ...
                                                valores_base +
                                                [n, e, z, codigo, zona_utm, id_enlace]
                                            )
